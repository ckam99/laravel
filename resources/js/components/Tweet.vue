<template>
    <div class="tweet flex border-b border-grey p-4">
        ...
        <div class="w-5/6 ml-8">
            <div class="mb-3">
                <span class="font-semibold">{{ tweet.fullname }}</span>
            ...
            <div class="flex justify-between w-64">
                <div
                    class="flex items-center text-grey-darkest cursor-pointer hover:text-blue"
                >
                    <div>
                        <svg
                            fill="currentColor"
                ...
                <div
                    class="flex items-center text-grey-darkest cursor-pointer hover:text-green"
                >
                    <div>
                        <svg
                            fill="currentColor"
                ...
                <div
                    class="flex items-center text-grey-darkest cursor-pointer hover:text-red"
                >
                    <div>
                        <svg
                            fill="currentColor"
